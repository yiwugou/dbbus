...
public class JdbcConfig {
    ...
    public static JdbcConfig init(Properties properties) {
        ...
        if (CommonUtils.isNotBlank(driver)) {
            ...
            throw new RuntimeException("jdbc driver must not be null");
        }
        ...
        if (CommonUtils.isNotBlank(url)) {
            ...
            throw new RuntimeException("jdbc url must not be null");
        }
        ...
        if (CommonUtils.isNotBlank(username)) {
            ...
            throw new RuntimeException("jdbc username must not be null");
        }
        ...
        if (CommonUtils.isNotBlank(password)) {
            ...
            throw new RuntimeException("jdbc password must not be null");
        }
